...
final List<SightPhoto> sightPhotosMocks = [
  ...
  const SightPhoto(url: 'https://picsum.photos/200/300?8'),
  const SightPhoto(url: 'https://picsum.photos/200/300?9'),
  const SightPhoto(url: 'https://picsum.photos/200/300?10'),
  const SightPhoto(url: 'https://picsum.photos/200/300?11'),
  const SightPhoto(url: 'https://picsum.photos/200/300?12'),
  const SightPhoto(url: 'https://picsum.photos/200/300?13'),
  const SightPhoto(url: 'https://picsum.photos/200/300?14'),
  const SightPhoto(url: 'https://picsum.photos/200/300?15'),
  const SightPhoto(url: 'https://picsum.photos/200/300?16'),
  const SightPhoto(url: 'https://picsum.photos/200/300?17'),
  const SightPhoto(url: 'https://picsum.photos/200/300?18'),
  const SightPhoto(url: 'https://picsum.photos/200/300?19'),
  const SightPhoto(url: 'https://picsum.photos/200/300?20'),
];
